...
asp_imports_summ_port_year <- asp_dat |> group_by(entry_year, CBP.Entry...Port.of.Entry.Code, CBP.Entry...Port.of.Entry.Name, CBP.Line...Country.of.Origin) |> summarise(
...
asp_imports_summ_port <- asp_dat |> group_by(CBP.Entry...Port.of.Entry.Code, CBP.Entry...Port.of.Entry.Name, CBP.Line...Country.of.Origin) |> summarise(
    total_quantity = sum(PG26...Net.Quantity, na.rm = TRUE)
) |> ungroup() |> arrange(desc(total_quantity))
